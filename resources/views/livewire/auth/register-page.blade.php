<div class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-end">
    <div class="w-full max-w-md mx-auto">
        <form class="bg-white dark:bg-gray-800 shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
            <div class="mb-5">
